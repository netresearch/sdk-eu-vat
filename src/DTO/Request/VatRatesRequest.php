...
{
    /**
     * @var array<string> Normalized member state codes
     */
    private array $memberStates;

    /**
     * @param array<string>     $memberStates Array of ISO 3166-1 alpha-2 country codes
     ...
     *
     * @return array<string> Array of uppercase ISO 3166-1 alpha-2 country codes
     */
