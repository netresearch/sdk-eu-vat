...
final class VatRate
{
     ...
     * 
     * @return bool True if the rate type is 'STANDARD'
     */
     ...
     * 
     * @return bool True if the rate type starts with 'REDUCED'
     */
     ...
     * 
     * @return bool True if the rate type is 'SUPER_REDUCED'
     */
     ...
     * 
     * @return bool True if the rate type is 'PK' or 'PARKING'
     */
     ...
     * 
     * @return bool True if the rate type is 'Z' or 'ZERO'
     */
     ...
     * 
     * @return bool True if the rate type is 'E' or 'EXEMPT'
     */
