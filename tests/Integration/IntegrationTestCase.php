...
abstract class IntegrationTestCase extends TestCase
{
     ...
     * @param array $options VCR options (e.g., record mode)
     */
     ...
     * 
     * @return bool True if REFRESH_CASSETTES env var is set
     */
     ...
     * @param int $expectedPrecision Expected decimal places
     * @param string $message Optional failure message
     */
